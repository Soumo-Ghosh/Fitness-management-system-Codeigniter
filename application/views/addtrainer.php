...
<html>
  ...
  <body style="background: url(<?php echo base_url();?>gym/images/3.jpg); background-size: 85% 115%;">
   ...
   <div class="container-fluid">
    <div class="row">
     ...
     <div class="card-body" style="background-color:#000000;color:#FFFFFF;">
                <center><h3>Register new Trainer</h3>
                </div> 
                <div class="card-body"></div>
                <form class="form-group" action="<?php echo base_url();?>index.php/MyController/doaddtrainer" method="post">
                    <label><h5>Trainer name:<h5></label>
