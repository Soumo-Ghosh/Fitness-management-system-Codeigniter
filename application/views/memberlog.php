...
<html lang="en">
  ...
  <body style="background: url(<?php echo base_url();?>gym/images/9.jpg); background-size: 100% 115%;">
  
  <form action="<?php echo base_url();?>index.php/Mycontroller/memberlogindo/" method="post">
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="<?php echo base_url();?>gym/images/10.jpg" class="card-img-top">
            <div class="card-body">
              <center>
              <h5>Member Login</h5><br>
