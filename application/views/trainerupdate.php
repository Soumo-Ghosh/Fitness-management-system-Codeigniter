...
<div class="card">
    ...
    <div class="card-body" style="background-color:#000000;color:#FFFFFF;">
                ...
                <form class="form-group" action="<?php echo base_url();?>index.php/Mycontroller/trainerdoupdate/" method="post">
...
<input type="text" name="shift" value="<?php echo $r->shift;?>" class="form-control"><br>
