...
<html lang="en">
  ...
  <body style="background: url(<?php echo base_url();?>gym/images/4.jpg); background-size: 105% 115%;">
  ...
  <form action="<?php echo base_url();?>index.php/Mycontroller/logindo/" method="post">
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#34495E;">
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            <img src="<?php echo base_url();?>gym/images/cardback.jpg" class="card-img-top">
            <div class="card-body">
              <center>
