...
<div class="card">
    ...
    <div class="card-body" style="background-color:#000000;color:FFFFFF;">
                <h3>Attendence update</h3>
                </div> 
                <div class="card-body"></div>
                <form class="form-group" action="<?php echo base_url();?>index.php/Mycontroller/addpresentdo" method="post">
                <label>Name</label>
<input type="text" name="name" value="<?php echo $r->name;?>" class="form-control"><br>
                <label>Attendence</label>
                    <input type="text" name="Attendence" value="<?php echo $r->Attendence;?>" class="form-control"><br>
